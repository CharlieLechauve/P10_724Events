...
// const Page = () => {             Ici on a un problème de récupération des data
  // const {last} = useData()
  // return <></>

const Page = () => {
  const { data } = useData();
  // changement de "last" pour correspondre aux attentes  
  const last =
    ...
    <>
        ...
        <section className="ServicesContainer">
          ...
          <div className="ListContainer">
            ...
            <ServiceCard imageSrc="/images/hall-expo.png">
              ...
              En tant que spécialistes de l’événementiel, nous saurons trouver
      ...
      <footer className="row">
        <div className="col presta">
          ...
          {/* React Dev Tools nous indique que les datas ne sont pas récupérées. C.f. "components" from RDTools */}
          {last && (
            <EventCard
              imageSrc={last?.cover}
              title={last?.title}
        ...
        <div className="col description">
          <Logo size="large" />
          <p>
            Une agence événementielle propose des prestations de services
